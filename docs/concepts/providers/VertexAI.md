...
You can utilize VertexAI Batch generations for running batch generations on VertexAI models via LangBatch.

## Data Format

OpenAI data format can be used in LangBatch for VertexAI. But the model name can be skipped here. And all the requests should have same model name.
...
VertexAI should be initialized with the project id and location.
